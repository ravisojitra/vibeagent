...
export const DiscordIcon = ({ size = 20 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill="currentColor" className="bi bi-discord" viewBox="0 0 16 16">
